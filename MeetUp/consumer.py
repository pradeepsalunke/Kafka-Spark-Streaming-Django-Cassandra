...
import kafka
from MeetUp.modelStream import modelStream
from MeetUp.utils import get_dict_val, load_json, datetime_from_epoch
from cqlengine.management import sync_table, create_keyspace

# Setup connection
from cqlengine import connection
kafka_brokers_list = ["192.168.1.173:9092"]  # We can put multiple brokers here.
